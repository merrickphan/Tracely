...
/**
 * Saved sessions, newest first, for the dashboard's Sessions list.
 *
 * `origin = 'main'` only. Floating-popup captures are throwaway clipboard
 * checks, and listing them would bury the passages someone actually worked on.
 */
